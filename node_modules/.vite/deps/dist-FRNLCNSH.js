...
function _(l3, u4, t3) {
  var i4, o3, r4, f4 = {};
  for (r4 in u4) "key" == r4 ? i4 = u4[r4] : "ref" == r4 ? o3 = u4[r4] : f4[r4] = u4[r4];
...
function g(n2, t3, i4, o3, r4) {
  var f4 = { type: n2, props: t3, key: i4, ref: o3, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: null == r4 ? ++u : r4, __i: -1, __u: 0 };
...
function S(n2, l3, u4, t3, i4, o3, r4, f4, e3, c3, s3) {
  var a3, p3, y3, d3, w3, _2 = t3 && t3.__k || v, g2 = l3.length;
  for (u4.__d = e3, $(u4, l3, _2), e3 = u4.__d, a3 = 0; a3 < g2; a3++) null != (y3 = u4.__k[a3]) && (p3 = -1 === y3.__i ? h : _2[y3.__i] || h, y3.__i = a3, O(n2, y3, p3, i4, o3, r4, f4, e3, c3, s3), d3 = y3.__e, y3.ref && p3.ref != y3.ref && (p3.ref && N(p3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), 65536 & y3.__u || p3.__k === y3.__k ? e3 = I(y3, e3, n2) : "function" == typeof y3.type && void 0 !== y3.__d ? e3 = y3.__d : d3 && (e3 = d3.nextSibling), y3.__d = void 0, y3.__u &= -196609);
  u4.__d = e3, u4.__e = w3;
}
function $(n2, l3, u4) {
  var t3, i4, o3, r4, f4, e3 = l3.length, c3 = u4.length, s3 = c3, a3 = 0;
  for (n2.__k = [], t3 = 0; t3 < e3; t3++) null != (i4 = l3[t3]) && "boolean" != typeof i4 && "function" != typeof i4 ? (r4 = t3 + a3, (i4 = n2.__k[t3] = "string" == typeof i4 || "number" == typeof i4 || "bigint" == typeof i4 || i4.constructor == String ? g(null, i4, null, null, null) : y(i4) ? g(b, { children: i4 }, null, null, null) : void 0 === i4.constructor && i4.__b > 0 ? g(i4.type, i4.props, i4.key, i4.ref ? i4.ref : null, i4.__v) : i4).__ = n2, i4.__b = n2.__b + 1, o3 = null, -1 !== (f4 = i4.__i = L(i4, u4, r4, s3)) && (s3--, (o3 = u4[f4]) && (o3.__u |= 131072)), null == o3 || null === o3.__v ? (-1 == f4 && a3--, "function" != typeof i4.type && (i4.__u |= 65536)) : f4 !== r4 && (f4 == r4 - 1 ? a3-- : f4 == r4 + 1 ? a3++ : (f4 > r4 ? a3-- : a3++, i4.__u |= 65536))) : i4 = n2.__k[t3] = null;
...
function O(n2, u4, t3, i4, o3, r4, f4, e3, c3, s3) {
  ...
  n: if ("function" == typeof T3) try {
    ...
    h3.state = h3.__s, null != h3.getChildContext && (i4 = d(d({}, i4), h3.getChildContext())), x2 && !v3 && null != h3.getSnapshotBeforeUpdate && (_2 = h3.getSnapshotBeforeUpdate(p3, w3)), S(n2, y(L2 = null != a3 && a3.type === b && null == a3.key ? a3.props.children : a3) ? L2 : [L2], u4, t3, i4, o3, r4, f4, e3, c3, s3), h3.base = u4.__e, u4.__u &= -161, h3.__h.length && f4.push(h3), g2 && (h3.__E = h3.__ = null);
  } catch (n3) {
  ...
  else null == r4 && u4.__v === t3.__v ? (u4.__k = t3.__k, u4.__e = t3.__e) : u4.__e = z(t3.__e, u4, t3, i4, o3, r4, f4, c3, s3);
  (a3 = l.diffed) && a3(u4);
}
function j(n2, u4, t3) {
  u4.__d = void 0;
...
function z(u4, t3, i4, o3, r4, f4, e3, c3, s3) {
  ...
  if (null === C3) b2 === k3 || c3 && u4.data === k3 || (u4.data = k3);
    ...
    else if (p3 && (u4.innerHTML = ""), S(u4, y(d3) ? d3 : [d3], t3, i4, o3, "foreignObject" === C3 ? "http://www.w3.org/1999/xhtml" : r4, f4, e3, f4 ? f4[0] : i4.__k && x(i4, 0), c3, s3), null != f4) for (a3 = f4.length; a3--; ) w(f4[a3]);
...
function B(u4, t3, i4) {
  var o3, r4, f4, e3;
  l.__ && l.__(u4, t3), r4 = (o3 = "function" == typeof i4) ? null : i4 && i4.__k || t3.__k, f4 = [], e3 = [], O(t3, u4 = (!o3 && i4 || t3).__k = _(b, null, [u4]), r4 || h, h, t3.namespaceURI, !o3 && i4 ? [i4] : r4 ? null : t3.firstChild ? n.call(t3.childNodes) : null, f4, !o3 && i4 ? i4 : r4 ? r4.__e : t3.firstChild, o3, e3), j(f4, u4, e3);
}
n = v.slice, l = { __e: function(n2, l3, u4, t3) {
  for (var i4, o3, r4; l3 = l3.__; ) if ((i4 = l3.__c) && !i4.__) try {
...
function p2(n2, u4, i4) {
  ...
  if (o3.t = n2, !o3.__c && (o3.__ = [i4 ? i4(u4) : D(void 0, u4), function(n3) {
    ...
    var f4 = function(n3, t3, r4) {
      ...
      }), !(!i5 && o3.__c.props === n3) && (!c3 || c3.call(this, n3, t3, r4));
    };
    r3.u = true;
...
function y2(n2, u4) {
  var i4 = d2(t2++, 3);
  !c2.__s && C2(i4.__H, u4) && (i4.__ = n2, i4.i = u4, r3.__H.__h.push(i4));
}
function T2(n2, r4) {
  var u4 = d2(t2++, 7);
...
var Dialog = class {
  ...
  render() {
    if (this.root) {
      B(u2("div", { children: u2(DialogContainer, { children: Array.from(this.items.entries()).map(([key, itemProps]) => _(DialogInstance, Object.assign({}, itemProps, { key, handleClose: () => {
        var _a;
        this.clear();
...
var hexes = Array.from({ length: 256 }, (_2, i4) => i4.toString(16).padStart(2, "0"));
...
var SHA1 = class extends HashMD {
  ...
  process(view, offset) {
    ...
    for (let i4 = 0; i4 < 80; i4++) {
      ...
      const T3 = rotl(A2, 5) + F2 + E + K2 + SHA1_W[i4] | 0;
      E = D2;
      D2 = C3;
      C3 = rotl(B3, 30);
      B3 = A2;
...
var K = Array.from({ length: 64 }, (_2, i4) => Math.floor(p32 * Math.abs(Math.sin(i4 + 1))));
...
var MD5 = class extends HashMD {
  ...
  process(view, offset) {
    ...
    for (let i4 = 0; i4 < 64; i4++) {
      ...
      F2 = F2 + A2 + K[i4] + MD5_W[g2];
      A2 = D2;
      D2 = C3;
      C3 = B3;
      B3 = B3 + rotl(F2, s3[i4 % 4]);
    }
    A2 = A2 + this.A | 0;
    B3 = B3 + this.B | 0;
    C3 = C3 + this.C | 0;
...
var Id160 = (() => Uint8Array.from(new Array(16).fill(0).map((_2, i4) => i4)))();
...
function split(lst, le = false) {
  ...
  for (let i4 = 0; i4 < len; i4++) {
    const { h: h3, l: l3 } = fromBig(lst[i4], le);
    [Ah[i4], Al[i4]] = [h3, l3];
  }
  return [Ah, Al];
}
...
var SHA256 = class extends HashMD {
  ...
  process(view, offset) {
    ...
    for (let i4 = 0; i4 < 64; i4++) {
      ...
      const T1 = H + sigma1 + Chi(E, F2, G) + SHA256_K[i4] + SHA256_W[i4] | 0;
...
function pad2(bytes, options = {}) {
  ...
  for (let i4 = 0; i4 < size5; i4++) {
    const padEnd = dir === "right";
    paddedBytes[padEnd ? i4 : size5 - i4 - 1] = bytes[padEnd ? i4 : bytes.length - i4 - 1];
  }
  return paddedBytes;
}
...
function concat2(...values) {
  ...
  for (let i4 = 0, index2 = 0; i4 < values.length; i4++) {
    const arr = values[i4];
...
function checksum2(address) {
  ...
  for (let i4 = 0; i4 < 40; i4 += 2) {
    if (hash8[i4 >> 1] >> 4 >= 8 && characters[i4]) {
      characters[i4] = characters[i4].toUpperCase();
    }
    if ((hash8[i4 >> 1] & 15) >= 8 && characters[i4 + 1]) {
...
function encodeString(value) {
  ...
  for (let i4 = 0; i4 < partsLength; i4++) {
    parts.push(padRight(slice2(hexValue, i4 * 32, (i4 + 1) * 32)));
  }
  return {
    dynamic: true,
...
function decode4(abiEvent, log) {
  ...
  for (let i4 = 0; i4 < indexedInputs.length; i4++) {
    ...
    args[isUnnamed ? i4 : param.name || i4] = (() => {
        ...
        if (decodedData) {
          if (isUnnamed)
            ...
            for (let i4 = 0; i4 < nonIndexedInputs.length; i4++) {
              const index2 = inputs.indexOf(nonIndexedInputs[i4]);
              args[nonIndexedInputs[i4].name || index2] = decodedData[i4];
            }
          }
        }
      } catch (err) {
...
function encode5(abiEvent, ...[args]) {
  ...
  if (args && abiEvent.inputs) {
    ...
    const args_ = Array.isArray(args) ? args : Object.values(args).length > 0 ? (indexedInputs == null ? void 0 : indexedInputs.map((x2, i4) => args[x2.name ?? i4])) ?? [] : [];
    if (args_.length > 0) {
      ...
      topics = (indexedInputs == null ? void 0 : indexedInputs.map((param, i4) => {
        if (Array.isArray(args_[i4]))
          return args_[i4].map((_2, j3) => encode9(param, args_[i4][j3]));
        return typeof args_[i4] !== "undefined" && args_[i4] !== null ? encode9(param, args_[i4]) : null;
      })) ?? [];
    }
  }
  const selector = (() => {
...
var integerToCharacter = Object.fromEntries(Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((a3, i4) => [i4, a3.charCodeAt(0)]));
var characterToInteger = {
  ...Object.fromEntries(Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((a3, i4) => [a3.charCodeAt(0), i4])),
  ["=".charCodeAt(0)]: 0,
  ["-".charCodeAt(0)]: 62,
  ["_".charCodeAt(0)]: 63
};
function fromBytes6(value, options = {}) {
  ...
  for (let i4 = 0, j3 = 0; j3 < value.length; i4 += 4, j3 += 3) {
    const y3 = (value[j3] << 16) + (value[j3 + 1] << 8) + (value[j3 + 2] | 0);
    encoded[i4] = integerToCharacter[y3 >> 18];
    encoded[i4 + 1] = integerToCharacter[y3 >> 12 & 63];
    encoded[i4 + 2] = integerToCharacter[y3 >> 6 & 63];
    encoded[i4 + 3] = integerToCharacter[y3 & 63];
  }
...
function toBytes7(value) {
  ...
  for (let i4 = 0, j3 = 0; i4 < base64.length; i4 += 4, j3 += 3) {
    const x2 = (characterToInteger[decoded[i4]] << 18) + (characterToInteger[decoded[i4 + 1]] << 12) + (characterToInteger[decoded[i4 + 2]] << 6) + characterToInteger[decoded[i4 + 3]];
    decoded[j3] = x2 >> 16;
...
var BLAKE2 = class extends Hash {
  ...
  digestInto(out) {
    ...
    swap32IfBE(buffer32);
    const out32 = u32(out);
    this.get().forEach((v3, i4) => out32[i4] = swap8IfBE(v3));
  }
  digest() {
    const { buffer: buffer2, outputLen } = this;
    this.digestInto(buffer2);
...
var BLAKE2b = class extends BLAKE2 {
  ...
  compress(msg, offset, isLast) {
    this.get().forEach((v3, i4) => BBUF[i4] = v3);
    BBUF.set(B2B_IV, 16);
...
var B3_SIGMA = (() => {
  const Id = Array.from({ length: 16 }, (_2, i4) => i4);
  const permute = (arr) => [2, 6, 3, 10, 7, 0, 4, 13, 1, 11, 12, 5, 9, 14, 15, 8].map((i4) => arr[i4]);
  const res = [];
  for (let i4 = 0, v3 = Id; i4 < 7; i4++, v3 = permute(v3))
    res.push(...v3);
...
var BLAKE3 = class _BLAKE3 extends BLAKE2 {
  ...
  _cloneInto(to3) {
    ...
    to3.stack = stack.map((i4) => Uint32Array.from(i4));
    to3.IV.set(IV);
    to3.flags = flags;
...
function merkelize(tree) {
  function inner(node) {
    ...
    while (level.length > 1) {
      const level_ = [];
      for (let i4 = 0; i4 < level.length; i4 += 2)
        level_.push(hash2(concat2(level[i4], level[i4 + 1])));
      level = level_;
    }
...
function toProofs(blobs, options) {
  ...
  const proofs = [];
  for (let i4 = 0; i4 < blobs_.length; i4++) {
    const blob = blobs_[i4];
...
function contains(bloom, input) {
  ...
  for (const i4 of [0, 2, 4]) {
    const bit = hash8[i4 + 1] + (hash8[i4] << 8) & 2047;
...
function namehash(name) {
  ...
  for (let i4 = labels.length - 1; i4 >= 0; i4 -= 1) {
    const hashFromEncodedLabel = unwrapLabelhash(labels[i4]);
    const hashed = hashFromEncodedLabel ? fromHex(hashFromEncodedLabel) : keccak2562(fromString2(labels[i4]), { as: "Bytes" });
...
function sign2(options) {
  ...
  const { r: r4, s: s3, recovery } = secp256k1.sign(from3(payload), from3(privateKey), {
...
function encodeType(value) {
  ...
  for (const type6 of deps) {
    result += `${type6}(${(types[type6] ?? []).map(({ name, type: t3 }) => `${t3} ${name}`).join(",")})`;
  }
  return result;
}
...
function encodeField(properties) {
  ...
  if (type6.lastIndexOf("]") === type6.length - 1) {
    ...
    return [
      { type: "bytes32" },
      keccak2562(encode2(typeValuePairs.map(([t3]) => t3), typeValuePairs.map(([, v3]) => v3)))
    ];
  }
...
async function parseCredentialPublicKey(response) {
  try {
    ...
    const findStart = (key) => {
      ...
      for (let i4 = 0; i4 < data.length - coordinate.length; i4++)
        if (coordinate.every((byte, j3) => data[i4 + j3] === byte))
          return i4 + coordinate.length;
      throw new CredentialCreationFailedError();
    };
        ...
        for (const log of txReceipt.logs) {
          if (((_a = log.address) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === usdcAddress) {
            try {
              ...
              console.error("[getPaymentStatus] Error parsing log:", e3);
            }
          }
        }
      }
...
*/
//# sourceMappingURL=dist-FRNLCNSH.js.map
