import {
  ...
  call_exports,
  mini_exports
} from "./chunk-IDMGF4IN.js";
import "./chunk-VUZ6PUUR.js";
...
import "./chunk-IY427ARV.js";
import "./chunk-FSM4ICS2.js";
import "./chunk-YL5B7ZW7.js";
import "./chunk-4JZWRFK7.js";
import "./chunk-4NN2I7SK.js";
import {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-FRNLCNSH.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-WPRW2KDF.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-EJARHEAL.js");
    ...
    return {
      ...
      async getProvider() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./_dist-IZBUWV4T.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-SSNPAFTP.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-5ESZSNDH.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-ECUYCDLE.js");
