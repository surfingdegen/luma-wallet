...
var require_Snackbar2 = __commonJS({
  "node_modules/cbw-sdk/dist/relay/walletlink/ui/components/Snackbar/index.js"(exports) {
    ...
    var __exportStar2 = exports && exports.__exportStar || function(m3, exports2) {
      for (var p3 in m3) if (p3 !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p3)) __createBinding2(exports2, m3, p3);
    };
    Object.defineProperty(exports, "__esModule", { value: true });
...
function __decorate(decorators, target, key, desc) {
  ...
  else for (var i3 = decorators.length - 1; i3 >= 0; i3--) if (d3 = decorators[i3]) r4 = (c3 < 3 ? d3(r4) : c3 > 3 ? d3(target, key, r4) : d3(target, key)) || r4;
...
function __read(o3, n2) {
  ...
  try {
    while ((n2 === void 0 || n2-- > 0) && !(r4 = i3.next()).done) ar.push(r4.value);
  } catch (error) {
    e3 = { error };
  } finally {
    try {
      if (r4 && !r4.done && (m3 = i3["return"])) m3.call(i3);
    } finally {
...
function __disposeResources(env) {
  ...
  function next() {
    while (r4 = env.stack.pop()) {
      try {
        if (!r4.async && s3 === 1) return s3 = 0, env.stack.push(r4), Promise.resolve().then(next);
        if (r4.dispose) {
          var result = r4.dispose.call(r4.value);
          if (r4.async) return s3 |= 2, Promise.resolve(result).then(next, function(e3) {
            fail(e3);
            return next();
          });
        } else s3 |= 1;
...
*/
//# sourceMappingURL=dist-EJARHEAL.js.map
